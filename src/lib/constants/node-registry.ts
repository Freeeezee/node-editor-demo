...
} from "@/src/lib/components/nodes/SineWaveGeneratorNode";
import {NodeComputeFunction} from "@/src/lib/models/node.model";
import NumberReaderNode, {
    computeNumberReaderNode,
    createNumberReaderNode,
    numberReaderNodeType
} from "@/src/lib/components/nodes/NumberReaderNode";
import ChartNode, {
    computeChartNode,
    createChartNode,
    chartNodeType
} from "@/src/lib/components/nodes/ChartNode";
import NumberNode, {computeNumberNode, createNumberNode, numberNodeType} from "@/src/lib/components/nodes/NumberNode";
import MathNode, {computeMathNode, createMathNode, mathNodeType} from "@/src/lib/components/nodes/MathNode";
